import { Component, Event, Prop, EventEmitter, Host, h, State } from '@stencil/core';
import { AmbulanceWaitingListApi, WaitingListEntry, Configuration } from '../../api/ambulance-wl';

@Component({
  tag: 'hd55-ambulance-wl-list',
  styleUrl: 'hd55-ambulance-wl-list.css',
  shadow: true,
})
export class Hd55AmbulanceWlList {
